...
public class ConnectionPoolUtil {
	...
	public JdbcCustomTemplate getNewJdbcCustomTemplate(Logger logger, Client client) throws TelAppointException, Exception {
		...
		try {
			...
			connectionPool
					.setMaxActive(Integer.valueOf(PropertyUtils.getValueFromProperties("MAX_ACTIVE", PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName())));
			connectionPool.setMaxIdle(Integer.valueOf(PropertyUtils.getValueFromProperties("MIN_IDLE", PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName())));

			String testOnBorrow = PropertyUtils.getValueFromProperties("testOnBorrow", PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName());
			String validationQuery = PropertyUtils.getValueFromProperties("validationQuery", PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName());
			String validationInterval = PropertyUtils.getValueFromProperties("validationInterval", PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName());
			String removeAbandoned = PropertyUtils.getValueFromProperties("removeAbandoned", PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName());
			String removeAbandonedTimeout = PropertyUtils.getValueFromProperties("removeAbandonedTimeout", PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName());
			String timeBetweenEvictionRunsMillis = PropertyUtils.getValueFromProperties("timeBetweenEvictionRunsMillis",
					PropertiesConstants.APPT_ADMIN_REST_SERVICE_PROP.getPropertyFileName());
