...
public class DateUtils {
	...
	public static String getDateString_MMDDYYYY_FromDate(Timestamp timestamp) {
		String dateTimeString = "";
		if (timestamp != null) {
			try {
				ThreadLocal<DateFormat> dateFormat = getSimpleDateFormat(CommonDateContants.MM_DD_YYYY_DATE_FORMAT.getValue());
				dateTimeString = dateFormat.get().format(timestamp);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public static String getCurrentDateMMDDYYYY_HHMM_TWELWE_HOURS(Date date) {
		ThreadLocal<DateFormat> df = getSimpleDateFormat(CommonDateContants.DATETIME_FORMAT_MMDDYYYY_HHMM_TWELWE_HOURS.getValue());
		return df.get().format(new Date());
	}

	public static void main(String... args) throws Exception {
		System.out.println("2017-02-04 21:48:07".substring(11));
		System.out.println(DateUtils.convert24To12HMMAFormat("2017-02-04 21:48:07".substring(11)));
