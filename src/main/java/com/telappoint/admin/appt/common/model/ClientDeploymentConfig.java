...
public class ClientDeploymentConfig {
	...
	private Integer resourceCalendarMonths;
	...
	public Integer getResourceCalendarMonths() {
		return resourceCalendarMonths;
	}

	public void setResourceCalendarMonths(Integer resourceCalendarMonths) {
		this.resourceCalendarMonths = resourceCalendarMonths;
	}
}
